...
class Level:
    ...
    def __repr__(self) -> str:
        return (f"Level(difficulty={self.difficulty}, budget={self.budget_tot}, "
...
class LevelBuilder:
    ...
    def build(self) -> Level:
        ...
        s'assure que les coordonnées des héros sont celles de l'entrée du donjon """
    ...
    def __repr__(self) -> str:
        return (f"LevelBuilder(difficulty={self._difficulty}, "
...
class LevelPresets:
    ...
    def custom(
        ...
        return (LevelBuilder()
            ...
            .set_budget(budget)
            .set_dungeon(dungeon)
            .add_heroes(count=hero_count, pv=hero_pv, start_coord=dungeon.entry, strategy=strategy)
            .build())
